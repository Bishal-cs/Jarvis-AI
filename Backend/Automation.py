...
GroqAPIKey = env_vars.get("GroqAPIKey") # get the api key from .env file 
...
# He generate content using ai an open in notepad 
def Content(Topic):
...
async def TranslateAndExcute(command: list[str]):
    ...
    for command in command:
        if command.startswith("open "):
            ...
            print(f"No function found for execution: {command}")
